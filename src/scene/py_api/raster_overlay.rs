    ...
    pub fn set_raster_overlay(
        ...
        let tex = crate::core::resource_tracker::tracked_create_texture(
            ...
            &wgpu::TextureDescriptor {
                ...
                // The scene color target (TEXTURE_FORMAT) is Rgba8Unorm and
                // stores display-encoded sRGB bytes. Keeping this texture
                // unorm makes fs_overlay a byte-exact passthrough; an sRGB
                // view would hardware-decode to linear and then store raw
                // into the unorm target, darkening the drape by ~gamma 2.2.
