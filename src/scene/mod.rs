...
impl SsaoResources {
    fn new(
        ...
        // Match cs_ssao bindings in ssao.wgsl:
        // @group(0) @binding(0) depth_texture   : texture_2d<f32>
        // @group(0) @binding(1) hzb_texture     : texture_2d<f32>
        // @group(0) @binding(2) normal_texture  : texture_2d<f32>
        // @group(0) @binding(3) noise_texture   : texture_2d<f32>
        // @group(0) @binding(4) tex_sampler     : sampler
        // @group(0) @binding(5) output_ao       : texture_storage_2d<r32float, write>
        // @group(0) @binding(6) settings        : uniform buffer
        // @group(0) @binding(7) camera          : uniform buffer
        let ssao_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                ...
                entries: &[
                    ...
                    // @group(0) @binding(2) - normal_texture
                    wgpu::BindGroupLayoutEntry {
                        binding: 2,
                        visibility: wgpu::ShaderStages::COMPUTE,
                        ty: wgpu::BindingType::Texture {
                    ...
                    // @group(0) @binding(3) - noise_texture
                    wgpu::BindGroupLayoutEntry {
                        binding: 3,
                        visibility: wgpu::ShaderStages::COMPUTE,
                        ty: wgpu::BindingType::Texture {
                    ...
                    // @group(0) @binding(5) - output_ao (storage texture)
                    wgpu::BindGroupLayoutEntry {
                        binding: 5,
                        visibility: wgpu::ShaderStages::COMPUTE,
                    ...
                    // @group(0) @binding(6) - settings uniform
                    wgpu::BindGroupLayoutEntry {
                        binding: 6,
                        visibility: wgpu::ShaderStages::COMPUTE,
                    ...
                    // @group(0) @binding(7) - camera uniform
                    wgpu::BindGroupLayoutEntry {
                        binding: 7,
                        visibility: wgpu::ShaderStages::COMPUTE,
                        ty: wgpu::BindingType::Buffer {
...
impl Scene {
    ...
    /// (SSGI/SSR/bloom) have observable output impact in offscreen renders.
    fn apply_runtime_postfx_cpu(&self, pixels: &mut [u8]) {
