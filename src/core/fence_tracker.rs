...
pub trait QueueFenceExt {
    ...
    fn submit_with_fence<I>(&self, command_buffers: I, fence_tracker: &mut FenceTracker, buffer_index: usize) -> FencedSubmission
    where
...
mod tests {
    use super::*;
    use wgpu::{Instance, Backends, DeviceDescriptor, RequestAdapterOptions};
