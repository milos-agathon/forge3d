...
pub(super) fn create_buffers(device: &Device) -> RenderResult<ConstructorBuffers> {
    Ok(ConstructorBuffers {
        ...
        counters_buffer: tracked_create_buffer(
            device,
            &BufferDescriptor {
        ...
        counters_readback: tracked_create_buffer(
            device,
            &BufferDescriptor {
        ...
        composite_params: tracked_create_buffer_init(
            device,
        ...
        temporal_params: tracked_create_buffer_init(
            device,
            &wgpu::util::BufferInitDescriptor {
