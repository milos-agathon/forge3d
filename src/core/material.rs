...
pub mod brdf {
    ...
    pub fn evaluate_cook_torrance(
        ...
        let base_color = Vec3::from_array([material.base_color[0], material.base_color[1], material.base_color[2]]);
...
pub mod presets {
    ...
    pub fn glass(color: Vec3) -> PbrMaterial {
        PbrMaterial::dielectric(color, 0.05).with_base_color(Vec4::new(color.x, color.y, color.z, 0.1))
    }
