...
pub fn create_reservoir_buffer(
    device: &Device,
    count: usize,
...
pub fn create_light_samples_buffer(
    device: &Device,
    samples: &[LightSample],
) -> Result<TrackedBuffer, RenderError> {
...
pub fn empty_light_samples_buffer(device: &Device) -> Result<TrackedBuffer, RenderError> {
...
pub fn empty_alias_entries_buffer(device: &Device) -> Result<TrackedBuffer, RenderError> {
...
pub fn build_light_samples_and_alias(
    ...
    Ok((light_buf, alias_buf, probs_buf))
}

/// Create GPU buffer for per-light probabilities
pub fn create_light_probs_buffer(
    device: &Device,
    probs: &[f32],
) -> Result<TrackedBuffer, RenderError> {
...
pub fn empty_light_probs_buffer(device: &Device) -> Result<TrackedBuffer, RenderError> {
    // Allocate at least 64 bytes to avoid small binding size issues
    let zeros: [u32; 16] = [0; 16];
    tracked_create_buffer_init(
        device,
...
pub fn create_diag_flags_buffer(
    device: &Device,
    pixel_count: usize,
) -> Result<TrackedBuffer, RenderError> {
...
pub fn create_debug_aov_buffer(
    device: &Device,
    pixel_count: usize,
) -> Result<TrackedBuffer, RenderError> {
...
pub fn create_restir_gbuffer_pos(
    device: &Device,
    pixel_count: usize,
) -> Result<TrackedBuffer, RenderError> {
