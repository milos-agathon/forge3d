...
// (src/offscreen/adjudication_raster.rs, production instanced PBR). Every numeric constant is a
// hard-coded literal: no RNG, no time, no environment lookups.
// RELEVANT FILES: src/shaders/pt_shade.wgsl, src/shaders/pt_scatter.wgsl, src/offscreen/adjudication_raster.rs
