...
impl WavefrontScheduler {
    ...
    pub fn resize(&mut self, width: u32, height: u32) -> Result<(), Box<dyn std::error::Error>> {
        ...
        self.aov_albedo = tracked_create_buffer(
            &self.device,
        ...
        self.aov_depth = tracked_create_buffer(
            &self.device,
            &wgpu::BufferDescriptor {
        ...
        self.aov_normal = tracked_create_buffer(
            &self.device,
            &wgpu::BufferDescriptor {
        ...
        self.medium_params = tracked_create_buffer_init(
            &self.device,
            &wgpu::util::BufferInitDescriptor {
    ...
    pub fn set_restir_light_data(
        &mut self,
        light_samples: TrackedBuffer,
        alias_entries: TrackedBuffer,
    ) {
        self.restir_light_samples = light_samples;
        self.restir_alias_entries = alias_entries;
    }

    pub fn set_restir_light_probs(&mut self, light_probs: TrackedBuffer) {
    ...
    pub fn set_hair_segments_buffer(&mut self, buffer: TrackedBuffer) {
    ...
    pub fn set_instances_buffer(&mut self, buffer: TrackedBuffer) {
        self.instances_buffer = buffer;
    }

    pub fn set_blas_descs_buffer(&mut self, buffer: TrackedBuffer) {
