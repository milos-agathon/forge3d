...
pub struct TerrainScene {
    ...
    pub(super) reflection_probe_ssbo: wgpu::Buffer,
    ...
    pub(super) reflection_probe_cached_data: Vec<crate::terrain::probes::GpuReflectionProbeData>,
