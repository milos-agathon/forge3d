...
if not f3d.has_gpu() or not all(
    ...
    pytest.skip("Terrain sky parity tests require GPU-backed native module", allow_module_level=True)
...
def _render_scene(renderer, material_set, ibl, heightmap, overlay, *, sky, light_azimuth_deg=135.0, light_elevation_deg=26.0):
