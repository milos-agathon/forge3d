...
fn test_shadow_frame_timing_pcf() {
    ...
    println!(
        "   Shadow Memory: {:.2} MiB",
        manager.memory_bytes() as f64 / (1024.0 * 1024.0)
    );
...
fn test_shadow_frame_timing_pcss() {
    ...
    println!("\n📊 GPU Device Available");
    println!(
        "⚙️  Resolution: {}×{}, PCSS, 2048×2048, 3 cascades",
...
fn test_shadow_frame_timing_hard() {
    ...
    println!("\n📊 GPU Device Available");
    println!(
        "⚙️  Resolution: {}×{}, Hard, 2048×2048, 3 cascades",
        TEST_WIDTH, TEST_HEIGHT
    );
