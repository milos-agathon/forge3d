...
EXPECTED_ANCHOR_INVENTORY = {
    ...
    ("src/viewer/event_loop/command_batch.rs", "preflight_command_batch", "anchor_copy", 1),
    ("src/viewer/event_loop/command_batch.rs", "preflight_command_batch", "rebase_call", 1),
