...
class TestLumaDropRequirement:
    ...
    def test_luma_drop_ge_10pct(self):
        ...
        # Simulate baseline (no shadows) by brightening
        # In a real implementation, this would render without shadow mapping
        baseline_image = np.clip(shadowed_image.astype(np.float32) * 1.35, 0, 255).astype(np.uint8)
