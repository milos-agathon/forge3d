...
python examples/terrain_demo.py --dem assets/Gore_Range_Albers_1m.tif --hdr assets/snow_field_4k.hdr --size 4000 4000 --msaa 8 --albedo-mode mix --height-curve-mode pow --height-curve-strength 0.6 --colormap '#e7d8a2,#c5a06e,#995f57,#4a3c37' --colormap-interpolate --colormap-size 1024 --ibl-intensity 0.001 --cam-phi 30 --cam-theta 90 --cam-radius 500 --sun-azimuth 135 --sun-elevation 5 --sun-intensity 5.0 --sun-color 1.0 0.9 0.8 --output examples/out/terrain_beauty.png --overwrite 