...
python examples/terrain_demo.py                                                                                                                                                              
    ...
    --size 4000 4000 --render-scale 1.25 --msaa 8 
    --albedo-mode colormap                                                                                                                                              
    --height-curve-mode pow --height-curve-strength 0.6 --height-curve-power 2.2                                                                                                                
    --colormap viridis --ibl-intensity 2.3                                                                                                                                                      
    --output examples/out/terrain_beauty.png --overwrite 