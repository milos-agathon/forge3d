...
CAMERA_PHI = 80.0
CAMERA_THETA = 55.0
CAMERA_RADIUS = 2400.0
CAMERA_FOV = 28.0
CAMERA_ZSCALE = 0.005
AMBIENT = 0.84
SHADOW = 0.16
NORMAL_STRENGTH = 0.54
HEIGHT_AO_STRENGTH = 0.45
HEIGHT_FLOOR = 20.0
HEIGHT_GAMMA = 1.45
COLOR_GAMMA = 1.12
...
def render_height_shade_map(dem_path: Path) -> None:
    ...
    try:
        ...
        base.send_ipc(sock, {"cmd": "set_overlay_preserve_colors", "preserve_colors": True})
        time.sleep(4)
