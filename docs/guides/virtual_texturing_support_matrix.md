...
| Runtime residency stats | `underdeveloped` | Lower-level stats exist; product validation integration is reported through large-scene diagnostics where metadata is available. | `unavailable_cache_lod_stats` when unavailable. |
