...
| Public Python scene integration | `underdeveloped` | `MapScene` can record 3D Tiles building intent and reports that public render preparation is incomplete. | `python_public_3dtiles_incomplete`. |
