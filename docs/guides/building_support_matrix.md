...
| Scalar PBR materials | `underdeveloped` | Scalar material values exist on `MapSceneBuildingLayer`; validation remains diagnostic-bearing. | `unsupported_feature` diagnostic for unsupported material paths. |
