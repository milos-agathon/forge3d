// Cascaded Shadow Maps - PCF Sampling and Cascade Selection
// PCF sampling functions and cascade selection logic
...
// Bind group for shadow sampling resources
