...
class ReflectionProbeSettings:
    """TV24: Local reflection probe configuration for terrain scenes."""
...
class VTLayerFamily:
    ...
    def __post_init__(self) -> None:
        ...
        # The current native terrain VT runtime pages only the albedo family.
...
class TerrainRenderParams:
    ...
    # TV24: Local reflection probes (defaults to disabled for backward compatibility)
    ...
    def __post_init__(self) -> None:
        ...
        # TV24: Default reflection probes to disabled if not provided
