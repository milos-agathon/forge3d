...
class PathTracer:
    ...
    def render_rgba(self, *args: Any, spp: int = ..., luminance_clamp: float | None = ..., firefly_clamp: float | None = ..., synthetic_ok: bool = ..., certificate: bool | str | None = ..., **kwargs: Any) -> np.ndarray: ...
...
def render_rgba(*args: Any, certificate: bool | str | None = ..., **kwargs: Any) -> np.ndarray: ...
