...
class CrsTransform:
    ...
    @property
    def datum_operations(self) -> list[dict[str, Any]]:
        """EPSG datum operations applied in order. Keys: epsg_code, name, method,
        method_epsg_code, source_datum, target_datum, reverse, translation_m, accuracy_m."""
        ...
